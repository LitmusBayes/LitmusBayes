...
BAYES_FILE = '../experiment/RQ2/final_results/post_final/median_results.json'
...
if num_tests_p1 > 0:
    ...
    fig1.savefig('../experiment/results/litmus_evaluation_speedup_RQ2_sorted.pdf', format='pdf')
    print("Saved: litmus_evaluation_speedup_RQ2_sorted.pdf")
...
fig2.tight_layout()
fig2.savefig('../experiment/results/litmus_evaluation_triggers_RQ2_sorted.pdf', format='pdf')
print("Saved: litmus_evaluation_triggers_RQ2_sorted.pdf")
