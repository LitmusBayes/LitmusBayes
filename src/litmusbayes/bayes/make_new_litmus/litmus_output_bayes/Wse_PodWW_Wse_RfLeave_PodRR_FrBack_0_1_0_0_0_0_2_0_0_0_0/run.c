...
static void end_report(int argc,char **argv,FILE *out) {
  ...
  fprintf(out,"%s\n","Command line: litmus7 -carch RISCV -limit true -mem direct -barrier userfence -stride 1 -size_of_test 100 -number_of_run 10 -driver C -gcc riscv64-unknown-linux-gnu-gcc -ccopts -O2 -linkopt -static -avail 4 ./make_new_litmus/litmus_output/A.litmus -o ./make_new_litmus/litmus_output_bayes/Wse_PodWW_Wse_RfLeave_PodRR_FrBack_0_1_0_0_0_0_2_0_0_0_0");
  fprintf(out,"%s\n","Parameters");
