...
class BestParamRunner(LitmusRunner):
    ...
    def _submit_one(self, task_info):
        ...
        params._temp_vec = [0, 1, 0, 0, 0, 0, 2, 0, 0, 0, 0]
...
litmus_path = "/home/whq/Desktop/code_list/perple_test/all_allow_litmus_C910_naive"
# stat_log = "./log_record_init_banana_final.log"
dir_path = "/home/whq/Desktop/code_list/perple_test/bayes_new_log"
log_path = "/home/whq/Desktop/code_list/perple_test/bayes_stat/log_stat_random.csv"
litmus_dir_path = '/home/whq/Desktop/code_list/perple_test/bayes'
...
if __name__ == "__main__":
    random.seed(SEED)
    stat_logs = [
        "./final_results/init/log_record_init_banana_final_1.log",
        "./final_results/init/log_record_init_banana_final_2.log",
        "./final_results/init/log_record_init_banana_final_3.log",
        "./final_results/init/log_record_init_banana_final_4.log",
        "./final_results/init/log_record_init_banana_final_5.log",
        "./final_results/init/log_record_init_banana_final_6.log",
        "./final_results/init/log_record_init_banana_final_7.log",
        "./final_results/init/log_record_init_banana_final_8.log",
    ]
    for stat_log in stat_logs:
        # 初始化 Log
