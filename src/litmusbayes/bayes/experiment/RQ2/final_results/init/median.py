...
# 1. 在这里定义好您的输入文件路径数组
input_files = [
    "log_record_init_banana_final_1.log.validation_cache.jsonl",
    "log_record_init_banana_final_2.log.validation_cache.jsonl",
    "log_record_init_banana_final_3.log.validation_cache.jsonl",
    "log_record_init_banana_final_4.log.validation_cache.jsonl",
    "log_record_init_banana_final_5.log.validation_cache.jsonl",
    "log_record_init_banana_final_6.log.validation_cache.jsonl",
    "log_record_init_banana_final_7.log.validation_cache.jsonl",
    "log_record_init_banana_final_8.log.validation_cache.jsonl",
]
