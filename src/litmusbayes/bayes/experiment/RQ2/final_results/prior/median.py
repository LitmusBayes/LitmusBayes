...
# 1. 在这里定义好您的输入文件路径数组
input_files = [
    "log_record_best_prior_1.log.validation_cache.jsonl",
    "log_record_best_prior_2.log.validation_cache.jsonl",
    "log_record_best_prior_3.log.validation_cache.jsonl",
    "log_record_best_prior_4.log.validation_cache.jsonl",
    "log_record_best_prior_5.log.validation_cache.jsonl",
    "log_record_best_prior_6.log.validation_cache.jsonl",
    "log_record_best_prior_7.log.validation_cache.jsonl",
    "log_record_best_prior_8.log.validation_cache.jsonl",
]
