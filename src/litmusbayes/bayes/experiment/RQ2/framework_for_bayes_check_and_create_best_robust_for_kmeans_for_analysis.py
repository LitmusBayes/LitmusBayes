...
if __name__ == "__main__":
    # 【新增】你的聚类 JSON 文件路径
    cluster_json_file = "./cluster_results_final_all_10/cluster_centers_all.json"  # 请替换为你的真实路径
    ...
    output_file = "best_params_recommendation_robust_final_kmeans_cross_10_factor_2_final_1.json"
    ...
    target_litmus_name = "S+rfi-data+addr-rfi-ctrlfencei"
