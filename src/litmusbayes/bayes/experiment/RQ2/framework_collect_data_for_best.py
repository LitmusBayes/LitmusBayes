...
json_recommendation_path = "best_params_recommendation_robust_prior2.json"
...
if __name__ == "__main__":
    ...
    # 初始化 Log
    stat_logs = [
        "./final_results/log_record_best_prior_1.log",
        "./final_results/log_record_best_prior_2.log",
        "./final_results/log_record_best_prior_3.log",
        "./final_results/log_record_best_prior_4.log",
        "./final_results/log_record_best_prior_5.log",
        "./final_results/log_record_best_prior_6.log",
        "./final_results/log_record_best_prior_7.log",
        "./final_results/log_record_best_prior_8.log",
    ]
