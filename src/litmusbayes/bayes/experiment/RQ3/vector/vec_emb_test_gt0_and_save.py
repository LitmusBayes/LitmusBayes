...
inference_input_file = "./raw_vector/litmus_vector_aligned.log" # 请修改为你的新文件路径
inference_output_file = "litmus_vector_emb.log"
...
if __name__ == "__main__":
    ...
    hand_test_rho = analyze_embedding_quality(X_test, y_test, method_name="Raw Manual Features (Test Set)")
    with open("../../results/rho_result.txt", "a+") as f:
        f.write(f"Handcrafted Features: {hand_test_rho}\n")
    # 7. 训练 DNN 映射
    ...
    dnn_rho = analyze_embedding_quality(emb_test, y_test, method_name="Test Set (Unseen)")
    with open("../../results/rho_result.txt", "a+") as f:
        f.write(f"Handcrafted Features + DNN: {dnn_rho}\n")
    print("=" * 60)
