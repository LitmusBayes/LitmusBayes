...
inference_graph_path = "./raw_vector/litmus_vector2.jsonl"  # 请修改你的新文件路径
inference_output_file = "litmus_vector_gnn.log"
...
if __name__ == "__main__":
    ...
    gnn_rho = analyze_embedding_quality(test_embs, test_perf, "Test Set (Unseen)")
    with open("../../results/rho_result.txt", "a+") as f:
        f.write(f"gnn : {gnn_rho}\n")
    print("=" * 30)
