...
from src.litmusbayes.bayes.logger_util import setup_logger
...
# ==========================================
# 路径配置
graph_json_path = "./raw_vector/litmus_vector2.jsonl"
stat_log_base = "./two_tower"
cache_file_path = "../../../log/cache_norm.jsonl"
litmus_cycle_path = "./raw_vector/litmus_vector3.log"  # 存放原始文本的文件


inference_graph_path = "./raw_vector/litmus_vector2.jsonl"
inference_text_path = "./raw_vector/litmus_vector3.log"  # 存放原始文本的文件
inference_output_file = "litmus_vector_two_tower.log"
...
if __name__ == "__main__":
    ...
    test_rho = analyze_embedding_quality(learned_test_emb, test_perf, method_name="Test Set (Unseen)")
    with open("../../results/rho_result.txt", "a+") as f:
        f.write(f"two-tower : {test_rho}\n")
    print("=" * 60)
