...
static void prelude(FILE *out) {
  fprintf(out,"%s\n","%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%");
  fprintf(out,"%s\n","% Results for /home/whq/Desktop/code_list/perple_test/all_allow_litmus_C910_naive_perple/WRC+fence.rw.rw+ctrlfencei.litmus %");
  fprintf(out,"%s\n","%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%");
  fprintf(out,"%s\n","RISCV WRC+fence.rw.rw+ctrlfencei");
  fprintf(out,"%s\n","\"Rfe Fence.rw.rwdRW Rfe DpCtrlFenceIdR Fre\"");
  fprintf(out,"%s\n","{0:x5=1; 0:x6=x; 1:x6=x; 1:x7=1; 1:x8=y; 2:x6=y; 2:x8=x;}");
  fprintf(out,"%s\n"," P0          | P1          | P2             ;");
