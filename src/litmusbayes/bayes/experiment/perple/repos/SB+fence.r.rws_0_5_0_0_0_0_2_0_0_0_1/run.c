...
static void end_report(int argc,char **argv,FILE *out) {
  ...
  fprintf(out,"%s\n","Command line: litmus7 -carch RISCV -limit true -affinity incr1 -force_affinity true -mem direct -barrier none -detached false -thread std -launch changing -stride 1 -size_of_test 100 -number_of_run 10 -driver C -gcc riscv64-unknown-linux-gnu-gcc -ccopts -O2 -linkopt -static -smtmode seq -smt 2 -avail 4 -alloc dynamic -contiguous false -noalign none /home/whq/Desktop/code_list/perple_test/all_allow_litmus_C910_naive_perple/SB+fence.r.rws.litmus -o /home/whq/Desktop/code_list/perple_test/bayes_banana_perple/SB+fence.r.rws_0_5_0_0_0_0_2_0_0_0_1");
  fprintf(out,"%s\n","Parameters");
