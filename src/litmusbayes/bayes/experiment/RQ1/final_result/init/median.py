...
# 1. 在这里定义好您的输入文件路径数组
input_files = [
    "log_record_init_1.log.validation_cache.jsonl",
    "log_record_init_2.log.validation_cache.jsonl",
    "log_record_init_3.log.validation_cache.jsonl",
    "log_record_init_4.log.validation_cache.jsonl",
    "log_record_init_5.log.validation_cache.jsonl",
    "log_record_init_6.log.validation_cache.jsonl",
    "log_record_init_7.log.validation_cache.jsonl",
    "log_record_init_8.log.validation_cache.jsonl",
